...
import { getMe } from '../../utils/API'; // Import the API utility
import './home.css';
...
class Home extends Component {
    ...
    componentDidMount() {
        ...
        if (token) {
            this.setState({ token }, this.fetchUserData);  // Set token and fetch user data
        }
    }
    ...
    fetchUserData = async () => {
        ...
        try {
            const user = await getMe(token);  // Fetch user data using the API utility
            console.log('Fetched user data:', user);
            this.setState({ user });  // Update state with the fetched user data
        } catch (err) {
